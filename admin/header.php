            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="index.php?act=themsach" aria-expanded="false"><i
                                    class="fa-solid fa-bowl-food"></i> <span class="mini-click-non">Sách</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="index.php?act=themsach"><span class="mini-sub-pro">Thêm mới sách</span></a>
                                </li>
                                <li><a href="index.php?act=lietkesach"><span class="mini-sub-pro">Liệt kê sách
                                            </span></a></li>
                            </ul>
                        </li>
